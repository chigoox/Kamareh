...
function AboutUs() {
  return (
    <div className='bg-white hidescroll  h-screen   relative overflow-x-hidden'>
      <Image className={`w-full h-96 rounded-none object-cover`} src={'Images/guy (8).jpg'} alt='picture'/>
    <div className={`center-col w-full md:w-1/3 p-2 m-auto`}>
      ...
      <Image className={`w-full h-96 object-cover`} src={'Images/guy (2).jpg'} alt='picture'/>
      <div className={``}>
      ...
      <Image className={`w-full h-24 object-cover`} src={'Images/guy (3).jpg'} alt='picture'/>
      <div className={``}>
...
<Image className={`w-full h-96 object-cover`} src={'Images/guy (6).jpg'} alt='picture'/>
      <div className={``}>
