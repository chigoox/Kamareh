  ...
  return (
    <div className='bg-white hidescroll  h-screen   relative overflow-x-hidden'>
      ...
      <div className="h-screen">
        ...
        <div className=" relative bg-black h-72 overflow-hidden">
          <Image className="rounded-none" src="https://cdn.shopify.com/s/files/1/0293/9277/files/09-04-24_S4_35_75513_Camel_CZ_IM_11-42-07_PLUS_61989_PXF.jpg?v=1725557043&width=1000&height=1500&crop=center" />
          <h1 className="text-3xl z-20 top-2 right-2 absolute">Jackets</h1>
        </div>
        <div className=" relative bg-black h-72 overflow-hidden">
          <Image className="rounded-none" src="https://cdn.shopify.com/s/files/1/0293/9277/files/06-17-24_S1_46_22GWF0958_Black_AZ_PC_11-49-16_39051_SL.jpg?v=1719256953&width=1000&height=1500&crop=center" />
