            ...
            <div className='center gap-4 p-2'>
                ...
                <div className='fadeInRight overflow-hidden w-3/4 md:w-[25%]'>
                    <div className='p-2 h-fit center flex-col'>
                        ...
                        <Input value={Email} onValueChange={(text) => setEmail(text)} label={'Email'} endContent={<Mail />} placement={'inside'} className=' m-auto text-black h-10 trans p-2 focus:scale-110 hover:scale-105' type="email" />
                        <Input value={name} onValueChange={(text) => setName(text)} label={'Full Name'} endContent={<User />} placement={'inside'} className='s m-auto text-black h-10 mt-1  trans p-2 focus:scale-110 hover:scale-105' type="text" />
